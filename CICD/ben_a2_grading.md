...
**Grader's Notes:** Missing automated testing and rollback of deployed container after it has been deployed to the Azure instance.
- Since your pipeline is completely automatic, if there are issues in your code or in your deployment, you will have broken your production environment once the deployment is finished.
  - To counteract this, you should have testing on the *deployed* instance and have an automated rollback system if the deployed instance fails any tests.
